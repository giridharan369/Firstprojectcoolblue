...
public class Base {
	...
	public static void login(WebDriver driver) throws IOException {
		takeScreenshot(driver,
				"C:\\Users\\GIRI\\Desktop\\selenium\\eclipse-workspace\\Blue\\ScreenShot\\successful5.jpeg");
		...
		takeScreenshot(driver,
				"C:\\Users\\GIRI\\Desktop\\selenium\\eclipse-workspace\\Blue\\ScreenShot\\successful1.jpeg");
	...
	public static void checkout(WebDriver driver) throws IOException {
		WebElement btnCheckout = FindElementByXpath(driver, "//button[@type='submit'][5]");
		btnCheckout.click();
		takeScreenshot(driver,
				"C:\\Users\\GIRI\\Desktop\\selenium\\eclipse-workspace\\Blue\\ScreenShot\\successfuladdcart.jpeg");
